...
diff = data.frame(y=MLA$Difference)
QQp = ggplot(data = diff) + 
  stat_qq(aes(sample=y)) + 
  theme_few(4) +
  coord_flip()

Question19_QQPlot = QQp +
