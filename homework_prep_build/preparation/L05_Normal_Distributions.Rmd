...
8. Determine whether the data represented in these Q-Q plots are normally distributed or not. Record your answer for each graph.  Justify your answer.

```{r,echo=FALSE,warning=FALSE,results='asis'}
#This dataset will provide all our abnormal qqplots.
...
#Plot A-------------------------------------------------------------
QQp = ggplot(data = NotNormal) + 
  stat_qq(aes(sample=Wage),size=.05) 

QQPlot_Q08_A = ggQQline(QQp,size=.85)+
  theme_bw(13)+
  coord_flip()+
  labs(x="",y="")+
  theme(axis.text=element_blank(),axis.ticks=element_blank())

ggsave(QQPlot_Q08_A,filename = "../images/L5_Prep_PartII_Q8_PlotA.png",width = 3.75,height = 3.00)

#Plot B--------------------------------------------------------------
QQp = ggplot(data = NotNormal) + 
  stat_qq(aes(sample=Credits),size=.05) 

QQPlot_Q08_B = ggQQline(QQp,size=.85)+
  theme_bw(13)+
  coord_flip()+
  labs(x="",y="")+
  theme(axis.text=element_blank(),axis.ticks=element_blank())
...
#Plot C--------------------------------------------------------------
QQp = ggplot(data = NotNormal) + 
  stat_qq(aes(sample=Age),size=.05) 

QQPlot_Q08_E = ggQQline(QQp,size=.85)+
  theme_bw(13)+
  coord_flip()+
  labs(x="",y="")+
  theme(axis.text=element_blank(),axis.ticks=element_blank())
...
#Plot C------------------------------------------------------------
QQp = ggplot(data = Normal) + 
  stat_qq(aes(sample=Density.determined.from.underwater.weighing),size=.05) 

QQPlot_Q08_C = ggQQline(QQp,size=.85)+
  theme_bw(13)+
  coord_flip()+
  labs(x="",y="")+
  theme(axis.text=element_blank(),axis.ticks=element_blank())
...
#Plot D-------------------------------------------------------------
QQp = ggplot(data = Normal) + 
  stat_qq(aes(sample=X.Wrist.circumference..cm.),size=.05) 

QQPlot_Q08_D = ggQQline(QQp,size=.85)+
  theme_bw(13)+
  coord_flip()+
  labs(x="",y="")+
  theme(axis.text=element_blank(),axis.ticks=element_blank())
...
QQp = ggplot(data = VeryNormal) + 
  stat_qq(aes(sample=x),size=.05) 

QQPlot_Q08_F = ggQQline(QQp,size=.85)+
  theme_bw(13)+
  coord_flip()+
  labs(x="",y="")+
  theme(axis.text=element_blank(),axis.ticks=element_blank())
