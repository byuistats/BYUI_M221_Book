...
**Part II:**  To answer the following questions, use the [Gharial Crocodiles Data.](http://statistics.byuimath.com/index.php?title=Data)

3. The Correlation Coefficient between Head Length and Body Length of the Gharial Crocodiles is:
	
4. The Covariance of the Head Length and the Body Length of the Gharial Crocodiles is:
...
#solutions
  ...
  Solution04 = data.frame(Part = "-",Solution = paste("$\\text{Covariance} ",Covar1,"$",sep = ""))
