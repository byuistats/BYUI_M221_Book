...
#---------------------------------------
#To make the QQplot for the novelists in question 7

QQp = ggplot(data = Novel) + 
  stat_qq(aes(sample=Age),size=.05) 

QQPlot_Q07_novel = ggQQline(QQp,size=.85)+
  theme_bw(13)+
  coord_flip()+
  labs(x="",y="")+
...
#---------------------------------------
#Makes the QQplot for the poets in question 7

QQp = ggplot(data = Poem) + 
  stat_qq(aes(sample=Age),size=.05)

QQPlot_Q07_poem = ggQQline(QQp,size=.85)+
  theme_bw(13)+
  coord_flip()+
  labs(x="",y="")+
  theme(axis.text=element_blank(),axis.ticks=element_blank())
...
#---------------------------------------
#Makes the QQplot for the non fiction writers in question 7

QQp = ggplot(data = Nonfiction) + 
  stat_qq(aes(sample=Age),size=.05)

QQPlot_Q07_nonfiction = ggQQline(QQp,size=.85)+
  theme_bw(13)+
  coord_flip()+
  labs(x="",y="")+
  theme(axis.text=element_blank(),axis.ticks=element_blank())
