...
Use the "Two-sample t Test" tab of the [Math 221 Statistics Toolbox](./Data/Math221StatisticsToolbox.xlsx) to create separate histograms, one for each group. You can enter a label for Group1 in L7, and a label for Group 2 in L8. 
...
Use the file [Math 221 Statistics Toolbox](./Data/Math221StatisticsToolbox.xlsx) to do the following:
