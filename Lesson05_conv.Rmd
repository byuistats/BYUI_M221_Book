...
{{YouTubeLesson|url=http://www.youtube.com/embed/videoseries?list=PLaZryQtbPQC94-G9-36oCixDqF97LTx6S}}
...
<p>Gustavo’s height is $ 182.5 − 173.0 = 9.5 \text{ cm  } \ $    above the mean. The standard deviation of the height of Brazilian men is 6.3 cm, so his height is   $ \displaystyle{ \frac{9.5}{6.3} =1.508 } \ $  standard deviations above the mean.</p>
</div>
&nbsp;
</div>
<br/>
...
Using this applet we can calculate proportions and probabilities based on the area under the normal curve. For the following examples, please open the [Normal Probability Applet](http://byuimath.com/apps/normprob.html)  and practice using it to find areas under the curve.
...
<img src="./Images/Serwa_z-score.PNG|400px">
...
<img src="./Images/Batting_average_z-score.PNG|400px|center">
...
<img src="./Images/Batting_average_percentiles.PNG|400px|center">
