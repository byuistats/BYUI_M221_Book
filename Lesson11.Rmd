...
Use Excel to calculate the following summary statistics:
<center>
...
**CAUTION:** The Excel Toolbox only works for datasets of 1,000 observations or less. This dataset contains 2,000 observations. If you create your own histogram and boxplot of the data, the graphs should look something like the image below
