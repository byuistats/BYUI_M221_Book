...
:The Excel file needed for this analysis is {{Spreadsheet|QIP}}.  We will use this Excel file to conduct the hypothesis tests for a single mean with $\sigma$ unknown.
...
[[File:BodyTemp-tTest-Excel.png|link=|400px|center]]
...
<div class="stats A">
When the data are entered into the file {{Spreadsheet|QIP}}, the following output is generated:

[[File:BabyBoom-Ttest-Excel.png|link=|400px|center]]
</div>
...
<div class="SoftwareHeading">Excel Instructions</div>
<div class="Summary">
:Copying the <span class=Link>[[Data|BLEU-Scores]]</span> data into the {{Spreadsheet|QIP}} file in Excel, we get the following:

[[File:BLEUscores-Exceloutput.png|link=|400px|center]]
<br>
</div>
<br>
...
<div class="SoftwareHeading">Excel Instructions</div>
<div class="Summary">
The following output was generated using the Excel file {{Spreadsheet|QIP}}:

[[File:EuroWeights-Output-Excel.png|link=|400 px|center]]
...
[[File:Excel-IncreaseDecimals.png|link=|400 px|center]]
</div>
<br>
</div>
<br>
