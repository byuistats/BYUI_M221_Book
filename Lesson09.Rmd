...
The area to the right of $z=9.757$ is so small, the normal probability applet gives the area as "1.7217e-22."  This is how a computer represents scientific notation.  This number is actually $1.7217\times 10^{-22}$ or in other words, 0.000 000 000 000 000 000 000 172 17. This is the probability that a mean of $\bar{x}=177.6$ pounds was observed just by chance assuming the true mean is $\mu = 140$ lbs.  This is very, very unlikely.  A more plausible explanation is that the mean weight of individuals in the population is greater than 140 pounds.
