...
Open the file [Math 221 Statistics Toolbox](https://byuistats.github.io/BYUI_M221_Book/Data/Math221StatisticsToolbox.xltx) and do the following:
...
The summary statistics can be obtained using the [Math 221 Statistics Toolbox](https://byuistats.github.io/BYUI_M221_Book/Data/Math221StatisticsToolbox.xltx).  Paste the three columns of data into the appropriate areas of column A, B, and C.  The summary statistics will appear in the table to the right labeled "Numerical Summary of the Data".
