...
:Open the file {{Spreadsheet|QIP}} and do the following:
...
::*Using {{Spreadsheet|QDS}}, under the Q-Q plot tab you can paste in each of the three groups of data separately, to test for normality.
...
:Data representative of the values reported by Emmons and McCullough are given in the file <span class=Link>[[Data|Gratitude-Stacked.xls]]</span>.  The data is divided up into three columns which represent Grateful, Hassels, and Events.  

:The summary statistics can be obtained using the {{Spreadsheet|QIP}}.  Paste the three columns of data into the appropriate areas of column A, B, and C.  The summary statistics will appear in the table to the right labeled "Descriptive Statistics".

:This yields the following output:

[[File:Gratitude-ANOVA-Output-Excel.png|link=|center]]
<br>
</div>
<br>
