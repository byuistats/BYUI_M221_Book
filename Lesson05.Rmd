...
-  Gustavoâ's height is $182.5 - 173.0 = 9.5 \text{ cm  }$    above the mean. The standard deviation of the height of Brazilian men is 6.3 cm, so his height is   $\displaystyle{ \frac{9.5}{6.3} =1.508 }$  standard deviations above the mean.
</div>
&nbsp;
</div>
<br>
...
<center>
<div width="90%">
<iframe height="500" width="700" align="center" frameborder="0" src="http://byuimath.com/apps/normprob.html?width=600&z=1&height=400&left=1&mid=0&right=1&area=a&static=0&title=1&border=0" ></iframe>
</div>

```{r, echo=FALSE}
#htmltools::includeHTML("http://byuimath.com/apps/normprob.html")
```
