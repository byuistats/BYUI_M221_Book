...
[[File:Lesson_03_Activity_06_Reading_1.jpg|link=|center]]
...
[[File:L03_A06_R02.jpg|link=|center]]
...
[[File:L03_A06_R03.jpg|link=|center]]
...
[[File:L03_A06_R04.jpg|link=|center]]
...
Using this applet we can calculate proportions and probabilities based on the area under the normal curve. For the following examples, please open the [http://byuimath.com/apps/normprob.html Normal Probability Applet] and practice using it to find areas under the curve.
...
[[File:Serwa z-score.PNG|400px|link=|center]]
...
[[File:Batting average z-score.PNG|400px|center|link=]]
...
First, we need to find the $z$-score that corresponds to the 90<sup>th</sup> percentile using the [http://byuimath.com/apps/normprob.html Normal Probability Applet].
...
[[File:Batting average percentiles.PNG|400px|center|link=]]
...
|-
| Original Equation
| align="right" | $ \displaystyle{ 1.282 } $ 
| $=$ 
| $ \displaystyle{ \frac{x – 0.261}{0.034 }} $
|-
| $~$
|-
| Multiply both sides by 0.034
| align="right" | $ \displaystyle{ 1.282 (0.034) } $ 
| $=$ 
| $ \displaystyle{ \frac{x – 0.261}{0.034 } \cdot (0.034) } $
|-
| $~$
|-
...
| align="right" | $ \displaystyle{ 1.282 (0.034) } $ 
| $=$ 
| $ \displaystyle{ x – 0.261 } $
|-
| $~$
|-
| Add 0.261 to both sides
| align="right" | $ \displaystyle{  0.261 + 1.282 (0.034) } $ 
| $=$ 
| $ \displaystyle{ 0.261 + (x – 0.261) } $
|-
| $~$
|-
| Simplify the right-hand side
...
| align="right" | $ \displaystyle{  0.305 } $ 
| $=$ 
| $ \displaystyle{ x } $
|-
| $~$
...
[[File:L04_QQ_Plot_01.jpg|link=|center]]
...
Each volunteer was given a physical to assure that they were not ill at the time of the data collection. Their axillary (under the arm) body temperature was measured and reported in a paper published in the Journal of the American Medical Association. [1] These data were extracted and are presented in the file <span class=Link>[[Data|BodyTemp]]</span>. The body temperatures are given in degrees Fahrenheit.
...
[[File:BodyTemperatures-Histogram.png|link=|400 px]]
...
[[File:BodyTemperatures-QQ.png|link=|400 px]]
...
[[File:L04_QQ_Plot_02.jpg|link=|center]]
...
[[File:L04_QQ_Plot_03.jpg|link=|center]]
...
[[File:L04_QQ_Plot_04.jpg|link=|center]]
...
<center>
[[File:AdamAndersen-Portrait.png|link=]] $~$ $~$ $~$ [[File:AdamAndersen-Family.png|link=]]
</center>
...
{| 
|- align="center"
| '''Previous Reading''': <br> Lesson 04:  <br> [[Lesson 4: Probability; Discrete Random Variables|Probability; Discrete Random Variables]]
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
| '''This Reading''': <br> Lesson 05:  <br> Normal Distributions
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
| '''Next Reading''': <br> Lesson 06:  <br> [[Lesson 6: Distribution of Sample Means & The Central Limit Theorem|Distribution of Sample Means & The Central Limit Theorem]]
|}
</center>
