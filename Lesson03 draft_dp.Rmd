...
* Create a box-plot from quantitative data. 
...
You can watch this short video of how to [create a histogram in Excel](https://screencast-o-matic.com/watch/cYV1YdvU35), or follow these steps:  
...
<img src="./Images/create_histogram_step2resized.png">  
...
<img src="./Images/create_histogram_step3.png">  
...
<img src="./Images/create_histogram_step4.png"> 

#### Step 4  
A menu of options will open on the right side of the screen. You can adjust the bid width or number of bins. In this case, though we can't make it match, in order to make the histogram look as much as possible like the one shown above, we will choose a bin width of 5000.

<img src="./Images/create_histogram_step5.png"> 
...
After summarizing the sample data numerically and graphically, we are ready to make inference about the population.
<br>
...
* Answers may vary.  -- We fail to reject the null hypothesis.  That means that we could not say that the true mean cost is not equal to $13,800.  So, there is not enough evidence of inflation.  There is no need for the Government of India to take action.
</div>
&nbsp;
</div>
<br>
...
<div class="Summary">
&nbsp;&nbsp;**To calculate any numerical summary (such as the mean, median, mode) in Excel, follow these steps:**
&nbsp;&nbsp;

* Enter the data into Excel. There should only be one data value per cell.    
* Next, in the cell where you would like store the numerical summary type an '=', follwed by the name of the function and then an open parenthesis, '('.  
* Then,  highlight the data to which you want to apply the function. The cell referece range will automatically be added to your formula. Then type a closed parenthesis, ')' and hit enter.

For example, to calculate the mean of the sample of tubercolisis patient costs in India first put the data in Excel. Then type **=average(**, highlight the data, and close the parenthesis with **)** before hitting enter:  

<div style="padding-left:30px;"><img src="./Images/Lesson_03_mean.png" width=50%></div>

* To calculate a median, simply replace the word "average" in the formula with the word "median". Try it with the tuberculosis patient data, you should get the same value that was calculated by hand above.

* Similarly, to calculate a mode, replace the word "average" in the formula with the word "mode" or "mode.sngl". NOTE: If you try this on the tuberculosis patient data, you will get a results of "#N/A". This is Excel's way of saying that a mode does not exist because there are no repeated values in the dataset.
...
<img src="./Images/Lesson_03_stdev.png">
...
First, observe the number line below, where each x represents the temperature of a patient with a relatively uncomplicated case of bird flue. As mentioned earlier, there is not a huge spread in the temperatures.
...
The deviation of an observation from the mean is the distance from the observation to the mean. In other words, deviations are the lengths of the line segments drawn in the image above.
...
The variance is the square of the standard deviation.  The sample variance is denoted by the symbol $s^2$.  We found the sample standard deviation for  patient temperatures of uncomplicated cases of bird  in the bird  above is $s = 0.74162$.  So, the sample variance for this data set is $s^2 = 0.74162^2 = 0.550$. Be aware, if I had squared the rounded value of $s^2 = 0.742$ in my calculation, I would have gotten an answer of 0.551 instead. This would be considered incorrect.
...
99. What is the mean, median, standard deviation and variance of the sample? 

<a href="javascript:showhide('Q99')"><span style="font-size:8pt;">Show/Hide Solution</span></a>
<div id="Q99" style="display:none;">

<img src="./Images/Lesson_03_summary_stats_severe_bird_flu.png">
</div>
<br>
...
98. Based on the histograms, who has a greater sample mean weight, men or elephant seals?

<a href="javascript:showhide('Q98')"><span style="font-size:8pt;">Show/Hide Solution</span></a>
<div id="Q98" style="display:none;">
* The mean is a measure of the center of a distribution. The mean weight of the men is less than the mean weight of the seals. We can see this because the bulk of the data in the histogram for the men’s weight is to the left of the seals'. The center of the distribution of elephant seals is about 195 kg. The center of the distribution of men's weight is located at about 100 kg on the number line. 
</div>
<br>

97. Based on the histograms, do the weights of men or elephant seals have a larger sample standard deviation? 

<a href="javascript:showhide('Q97')"><span style="font-size:8pt;">Show/Hide Solution</span></a>
...
The wrong-site data in the file ranges from row 2 to row 412 in column A. So, to calculate the 25<sup>th</sup> percentile of the wrong site data you should would enter the following formula in a blank cell somewhere in the file:
...
<img src="./Images/Lesson_03_boxplot.png">
...
<div class="QuestionsHeading">Answer the following questions:</div>
<div class="Questions">
89. Create a histogram of the **wrong-patient** lawsuit data, located in column B of  the file [WrongSiteWrongPatient.xlsx](./Data/WrongSiteWrongPatient.xlsx). What is the shape of the wrong-patient data?
...
<a href="javascript:showhide('Q89')"><span style="font-size:8pt;">Show/Hide Solution</span></a>
...
<img src="./Images/Lesson_03_wrong-patient_histogram.png">
...
88. Create a boxplot of the **wrong-patient** lawsuit data.

<a href="javascript:showhide('Q88')"><span style="font-size:8pt;">Show/Hide Solution</span></a>
<div id="Q88" style="display:none;">


<img src="./Images/Lesson_03_wrong-patient_boxplot.png">
...
<img src="./Images/Lesson_03_boxplot_side-by-side.png">
...
&nbsp;&nbsp;**To create a side-by-side boxplots in Excel, do the following**
...
<img src="./Images/Lesson_03_boxplot_legend.png">
