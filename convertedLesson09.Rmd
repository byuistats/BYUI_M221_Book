...
<iframe width="90%" align="right" src="http://www.youtube.com/embed/videoseries?list=PLaZryQtbPQC9C5z9NWEjdRaS7h--99Kwv" frameborder="1" allow="autoplay; encrypted-media" allowfullscreen></iframe>
</div>
...
The scientific method demands that we make a hypothesis (a claim or an educated guess).  We assume that the null hypothesis is true and gather e  vidence against it.  In other words, we "do research" (e.g., collect data) to gather evidence against that hypothesis.  If we can gather enough evidence to discredit our initial hypothesis, we conclude that it was false, and begin the process again.
...
<tr class="even">
<td><p>&quot;If the $P$ is low,<br />
Reject the null.&quot;</p></td>
</tr>
</tbody>
</table>
</center>
