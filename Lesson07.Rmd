...
{{YouTubeLesson|url=http://www.youtube.com/embed/videoseries?list=PLaZryQtbPQC9Vm2oOb7MbspQvlvrkQba1}}
...
:*The standard deviation of the random variable $\bar X$ is $\displaystyle{\frac{σ}{\sqrt{n}}}$.
...
[[File:L04_A06_Graph.jpg|link=|center]]
...
<div class="mw-collapsible mw-collapsed" data-collapsetext="Hide Solution" data-expandtext="Show Solution">
::The $z$-score is:<br>
<center>$ \displaystyle{z = \frac{-25 – (-23)}{7} = –0.2857} $</center>
::Using the normal probability applet, we find that the area to the left of $z$ = –0.2857 is $0.3876$.
</div>
&nbsp;
</div>
...
If the sample mean is normally distributed, then we can consider the sample mean, $\bar x$, as one observation from a normal distribution with mean $\mu$ and standard deviation $\displaystyle{\frac{σ}{\sqrt{n}}}$. With this in mind, we can compute the $z$-score for any value of this random variable:
...
After finding the $z$-score, we can use the normal probability applet to find the area under the curve (i.e. the probability.)  Suppose that a sample of size $ n = 4 $ has been drawn from a normal population with mean $\mu = 7 $ and standard deviation $ \sigma = 3 $. Since the parent population is normal, we know the sampling distribution of the sample mean $\bar x$ will be normal with mean $\mu = 7 $ and standard deviation $ \displaystyle{ \frac{σ}{\sqrt{n}} = \frac{3}{\sqrt{4}} = 1.5}$. We can use this information to find the probability that $\bar x$ will be greater than 10.
...
[[File:L04_A06_Graph_2.jpg|link=|center]]
...
The distribution of the weekly costs incurred by Global Solutions Unlimited is right skewed.  The population mean of the costs is <nomathjax>$</nomathjax>26,400 and the standard deviation is <nomathjax>$</nomathjax>23,200.  A random sample of $ n = 40 $ weeks is to be selected, what is the probability that the mean weekly costs will be less than <nomathjax>$</nomathjax>20,000?

Since the number of observations  is large, the Central Limit Theorem assures that the sample mean will follow a normal distribution.  The $z$-score for $ \bar x = $ <nomathjax>$</nomathjax>20,000 is:
...
[[File:L04_A06_Graph_3.jpg|link=|center]]

The area to the left of $ z= –1.745 $ is $0.04049$.  This is the probability that the mean costs for the $n = 40$ weeks will be less than <nomathjax>$</nomathjax>20,000.
...
[[File:L07 AREA CLOSED sign.jpg|link=|400px|frame|From [http://happeningstock.deviantart.com/art/Grass-Hill-Area-Closed-Sign-255592183 deviantart.com] ]]
...
Measurements were taken from the mounds to assess one of the contaminants, lead.  The tests involved are very expensive.  Each sample costs about <nomathjax>$</nomathjax>600 to process.
...
Scientists collected $n = 61$ measurements of the lead concentration in the soil, measured in mg/kg.  The data are given in the file <span class=Link>[[Data|Uranium Plant Data-Lead]]</span>.
...
{{Course_Filter_Two|A=[[File:LeadContamination-Histogram.png|link=]]|B=[[File:L07 SPSS Histogram Lead Contamination.jpg|link=|400px]]}}
...
Since the sample size is large ($n = 61$), we can conclude that the sample mean is normally distributed.  So, we can use the normal probability applet to find the probability that the sample mean will be less than 29.13.  Historical analyses show that the population standard deviation is σ = 24 mg/kg.
...
[[File:L04_A06_Graph_4.jpg|link=|center]]
...
#Once we have determined that the sample mean is Normally distributed, we can compute probabilities with $\bar{x}$. We first compute $z = \frac{\bar{x} - \mu}{\sigma/\sqrt{n}}$ and then use the Normal Probability Applet to compute probabilities about $z$.
...
{|
|- align="center"
| '''Previous Reading''': <br> Lesson 06:  <br> [[Lesson 6: Distribution of Sample Means & The Central Limit Theorem|Distribution of Sample Means & The Central Limit Theorem]]
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
| '''This Reading''': <br> Lesson 07:  <br> Probability Calculations involving a Mean Response
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
| '''Next Reading''': <br> Lesson 08:  <br> [[Lesson 8: Review for Exam 1|Review for Exam 1]]
|}
</center>
