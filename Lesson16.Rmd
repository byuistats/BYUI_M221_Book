...
:*Open the data file <span class=Link>[[Data|NoClickQuery-Summary.xls]]</span>.  This file contains a summary of the NoClickQuery data.  Notice that each row in this data file represents the responses of several individuals.  The ''Count'' column tells how many times each response was given.  The data in this file have been summarized.  
...
[[File:NoClickQuery-Pie-Excel.png|link=|center]]
<br>
</div>
<br>
...
[[File:NoClickQuery-Bar-Excel.png|link=|center]]
<br>
</div>
<br>
...
[[File:NoClickQuery-Pareto-Excel.png|link=|center]]
<br>
</div>
<br>
