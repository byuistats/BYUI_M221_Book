...
[[File:testtaking-exam.jpg|center|400px|link=]]
...
[[File:SelfEfficacy-Scatterplot-SPSS.png|link=|center]]
...
[[File:Scatter-HotDog.png|link=|center]]
...
::* Open the [CategoricalDataAnalysis.xlsx](./Data/CategoricalDataAnalysis_Hat.xlsx) file.
...
[[File:EstuarineCrocodile-Scatterplot-Excel.png|link=|400px|center]]
<br>
...
[[File:OldFaithfulCorrelation-Excel.png|link=|center]]

:An easier way to do this is to use the file [CategoricalDataAnalysis.xlsx](./Data/CategoricalDataAnalysis_Hat.xlsx).  After entering the data in the first two columns, the correlation coefficient is given as "r" in cell E8 of that spreadsheet.
<br>
...
|-
|[[File:CorrOutliersR-37.png|link=]] || [[File:CorrOutliersR62.png|link=]] || [[File:CorrOutliersR88.png|link=]]
|-
...
! Figure 15 !! Figure 16
|-
|[[File:CorrNonlinModRelWeakCorr.png|link=]] || [[File:CorrNonlinModRelStrongCorr.png|link=]]
|-
|$r = +0.04$ || $r = +0.74$    
|}
</center>
...
[[File:OldFaithful-NPS-05232.png|link=|center|frame|<center>Eruption of the Old Faithful Geyser<br>(Photo credit: William S. Keller, U.S. National Park Service)</center>]]
...
<center>
[[File:OldFaithfulHistogram.png|link=]]
</center>
...
[[File:OldFaithfulEruptions-Scatterplot-Excel.png|link=|center]]
