...
An easier way to do this is to use the file [Math 221 Statistics Toolbox](./Data/Math221StatisticsToolbox.xlsx).  After entering the data in the first two columns in the Linear Regression worksheet, the correlation coefficient is given as "r" in cell F7 of that spreadsheet.
<br>
