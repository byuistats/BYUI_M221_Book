...
<center>
<img src="./Images/Mahon-Differences-QQ_Excel_Toolbox.png">
</center>
...
The test statistic, $t$, is labeled on the horizontal axis.  The $P$-value is the area to the left of $t$ under the curve.  This area is so small, it is not illustrated on this plot.  
...
Note that the data set has the columns listed with $d = REE_2$ in the first column and $d = REE_1$ in the second column. You will need to switch the order of the columns when pasting them into the Excel Toolbox.
...
<center>
<img src="./Images/REE-QQ-Excel_Toolbox.png">
</center>
...
* The test statistic is plotted on the horizontal axis.  The $P$-value is shaded in green. The same value can be found on the Excel output in cell R10.  
&nbsp
<center>
