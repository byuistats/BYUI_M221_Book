...
[[File:Mahon-DifferencesInExcel.png|link=|center]]
...
[[File:Mahon-DifferencesInExcel-2.png|link=|center]]

:If you want to remove the formulas to make it easier to paste the differences into the {{Spreadsheet|QIP}} file, do the following:
::* Select the column of differences
::* Copy the column ([Ctrl]-c is the keyboard shortcut for PCs.)
::* Click on the bottom half of the "Paste" button in the "File" ribbon of Excel: [[File:PasteButtonInFileRibbon.png]]
::* Choose Paste Values, as illustrated below:

[[File:Mahon-DifferencesInExcel-3.png|link=|center]]

:Now, the cells contain the subtracted differences, rather than the equation for these differences.  You are now ready to perform the calculations for a hypothesis test.  The hypothesis test will be conducted using the file {{Spreadsheet|QIP}}.
::* Copy the first 2 columns of data that you generated above
::* Open the file {{Spreadsheet|QIP}}
...
[[File:Mahon-Output-Excel-95CI.png|link=|400px|center]]
<br>
</div>
...
::*Follow the directions given '''[[#SubtractDifferences|above]]''' for creating a new column containing the differences between two variables.
::*Open the file {{Spreadsheet|QIP}}
