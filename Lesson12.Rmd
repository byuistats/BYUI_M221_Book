...
The requirement of normality is satisfied for Mahon's data. Though the sample size (n=27) is not quite up to 30, it is still fairly large. Furthermore, the histogram of differences appear to follow a normal distribution, so $\bar d$ will be approximately normal.  
