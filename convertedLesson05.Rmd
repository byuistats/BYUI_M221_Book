...
Approximately 68% of the observations from a bell-shaped distribution will be between the values of $\mu -~\sigma~$and $\mu +~\sigma~$. Consider the heights of young adult women in Ghana. We expect that about 68% of Ghanian women have a height between the values of
...
-  Relative to other Ghanian women, Serwa is very tall.  Gustavo is tall relative to Brazilian men, but relative to people of his gender and nationality, he is not relatively taller than Serwa.  Serwa has a higher $z$-score.
</div>
<br>
...
<center>
{{#widget:Iframe
|url=http://byuimath.com/apps/normprob.html?width={{{width|600}}}&z={{{z|1}}}&height={{{height|400}}}&left={{{left|1}}}&mid={{{mid|0}}}&right={{{right|1}}}&area={{{area|a}}}&static={{{static|0}}}&title={{{title|1}}}&border={{{border|0}}}
|width={{{fwidth|650}}}
|height={{{fheight|450}}}
|border=0
}}
...
Using this applet we can calculate proportions and probabilities based on the area under the normal curve. For the following examples, please open the [Normal Probability Applet](http://byuimath.com/apps/normprob.html){target="_blank"} and practice using it to find areas under the curve.
...
- **Here is how to make a Q-Q plot in Excel**
- Open the data file [BattingAverages.xlsx](./Data/BattingAverages.xlsx)
- Copy the data you needs from this file (the column labeled BattingAvg)
- Open the file [Quantitative Descriptive Statistics](./Data/QuantitativeDescriptiveStatistics.xlsx)
- Click on the tab labeled “QQ Plots”
- Paste the data into Column A of the QQ plots worksheet
  + Sort Column A in order from smallest to largest.
  + The graph on the right will be your Q-Q plot.

<img src="./Images/Excel_QQ-Plot_ _L05.jpg">
<br>
</div>
<br>
...
<img src="./Images/BodyTemperatures-Histogram.png">

Note that the mean is 98.23, standard deviation is 0.738, and sample size is n = 148.
...
<img src="./Images/BodyTemperatures-QQ.png">
...
<a href="javascript:showhide('Q8')"><span style="font-size:8pt;">Refresh My Memory</span></a>
