...
1.	Based on the following Q-Q plot, how would you classify the distribution of the data?
...
qqnorm(y=y,  main = "Q-Q plot for Normality Check")
qqline(y, col = 2)

```


2.	Based on the following Q-Q plot, how would you classify the distribution of the data?
...
```{r, include=FALSE}
#Making the two qqPlots in order to show them in the answer key. So students can see that Volume is distinctly abnormal. 
...
###QQ-Plot for Price
QQp = ggplot(data = NASDAQ) + 
  stat_qq(aes(sample=Price..US..),size=.05) 

QQPlot_Q03_Price = ggQQline(QQp,size=.85)+
  theme_bw(13)+
  coord_flip()+
  labs(x="",y="",title = "Price")+
  theme(axis.text=element_blank(),axis.ticks=element_blank())

ggsave(QQPlot_Q03_Price,filename = "../../images/L5_Homework_Q03_QQPlot_Price.png",width = 3.75,height = 3.00)

###Qqplot for Share Volume
QQp = ggplot(data = NASDAQ) + 
  stat_qq(aes(sample=Share.Volume),size=.05) 

QQPlot_Q03_Volume = ggQQline(QQp,size=.85)+
  theme_bw(13)+
  coord_flip()+
  labs(x="",y="",title = "Share Volume")+
  theme(axis.text=element_blank(),axis.ticks=element_blank())

ggsave(QQPlot_Q03_Volume,filename = "../../images/L5_Homework_Q03_QQPlot_Volume.png",width = 3.75,height = 3.00)

```


The data set [NASDAQ Price and Volume](http://statistics.byuimath.com/index.php?title=Data) summarizes information on select companies that are traded on NASDAQ.  The table gives the symbol for the company, the company's name, the price of their stock and the number of shares that have been traded (the volume).  Use this information to answer question 3.
...
10. According to the Q-Q plot below, the data are ... (finish the sentence) 
...
QQp = ggplot(data = Melt.Dentist) + 
  stat_qq(aes(sample=value),size=.05) 

ggQQline(QQp,size=.85)+
  theme_bw(13)+
  coord_flip()+
  labs(x="",y="")+
  theme(axis.text=element_blank(),axis.ticks=element_blank())
