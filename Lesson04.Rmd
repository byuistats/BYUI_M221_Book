...
* Identify the spread of a distribution for a bell-shaped histogram.
...
* Interpret the five-number summary for both skewed and bell-shaped quantitative data.
...
<a href="javascript:showhide('Q18')"><span style="font-size:14pt;">**Optional Reading:** Click Here to Explore How to Calculate the Mean and Standard Deviation of a Discrete Random Variable</span></a>
...
The table below illustrates the profit for all possible outcomes in a drawing where the grand prize is \$200,000,000. The symbol "O" represents one white ball was correctly guessed, and the symbol <span style="color:red;">P</span> represents that the powerball was correctly guessed.
  ...
  OOOP            \$100             \$98            $\dfrac{14\text{,}310}{175\text{,}223\text{,}510}$
  OOO             \$7               \$5             $\dfrac{486\text{,}540}{175\text{,}223\text{,}510}$
  OOP             \$7               \$5             $\dfrac{248\text{,}040}{175\text{,}223\text{,}510}$
  OP              \$4               \$2             $\dfrac{1\text{,}581\text{,}255}{175\text{,}223\text{,}510}$
