...
{{YouTubeLesson|url=http://www.youtube.com/embed/videoseries?list=PLaZryQtbPQC-a7rYECFUKhL6yMzvOIwCO}}
==Lesson Outcomes==
...
[[File:Columbus_taking_possession_of_the_new_country.jpg|link=|right|300px]]
...
<div style="clear:both"></div>
<div class="mw-collapsible mw-collapsed" data-collapsetext="Hide Solution" data-expandtext="Show Solution">
::Since all the numbers are equally likely, we would expect to roll each of the values 1 through 6 about $ \displaystyle{\frac{1}{6} } $ of the time.  So the proportion of time that each digit would occur is $ \displaystyle{\frac{1}{6} } = 0.1667 $.
</div>
...
! Value
! Count
! Value $\times$ Proportion
|-
| $$1$$
| $\displaystyle{\frac{1047}{6000}≈ 0.1745}$
| $$1(0.1745)$$
|-
| $$2$$
| $\displaystyle{\frac{968}{6000}≈ 0.1613}$
| $$2(0.1613)$$
|-
| $$3$$
| $\displaystyle{\frac{961}{6000}≈ 0.1602}$
| $$3(0.1602)$$
|-
| $$4$$
| $\displaystyle{\frac{1006}{6000}≈ 0.1677}$
| $$4(0.1677)$$
|-
| $$5$$
| $\displaystyle{\frac{980}{6000}≈ 0.1633}$
| $$5(0.1633)$$
|-
| $$6$$
| $\displaystyle{\frac{1038}{6000}≈ 0.1730}$
| $$6(0.1730)$$
|-
| 
| Sum: 1 
| Sum:$\bar x \approx 3.5030$
|}
</center>
...
| $\displaystyle{\frac{1}{6}≈ 0.1667}$
| $$1(0.1667)$$
| $(1-3.5)^2\times(0.1667) = 1.0417$
|-
| $$2$$
| $\displaystyle{\frac{1}{6}≈ 0.1667}$
| $$2(0.1667)$$
| $(2-3.5)^2\times(0.1667) = 0.3750$
|-
| $$3$$
| $\displaystyle\frac{1}{6}≈ 0.1667$
| $$3(0.1667)$$
| $(3-3.5)^2\times(0.1667) = 0.0417$
|-
| $$4$$
| $\displaystyle\frac{1}{6}≈ 0.1667$
| $$4(0.1667)$$
| $(4-3.5)^2\times(0.1667) = 0.0417$
|-
| $$5$$
| $\displaystyle\frac{1}{6}≈ 0.1667$
| $$5(0.1667)$$
| $(5-3.5)^2\times(0.1667) = 0.3750$
|-
| $$6$$
| $\displaystyle\frac{1}{6}≈ 0.1667$
| $$6(0.1667)$$
| $(6-3.5)^2\times(0.1667) = 1.0417$
|-
| 
| $$1$$
| Sum: $\mu≈3.5$
| Sum: Variance = $\sigma^2 = 2.9167$ 
|}
</center>
...
The profit is the amount a player wins minus the cost to play (<nomathjax>$</nomathjax>2 ). So, if a person wins a prize of <nomathjax>$</nomathjax>4, their profit is <nomathjax>$</nomathjax>2.  If a person loses, their profit is <nomathjax>$</nomathjax>–2. We will assume that the grand prize is <nomathjax>$</nomathjax>200,000,000&mdash;although in many drawings it will be much less than this.

The table below illustrates the profit for all possible outcomes in a drawing where the grand prize is <nomathjax>$</nomathjax>200,000,000. The symbol "O" represents one white ball was correctly guessed, and the symbol <span style="color:red;">P</span> represents that the powerball was correctly guessed.
...
! P$ (x) $
|- align="center"
| OOOOO<span style="color:red;">P</span>
| <nomathjax>$</nomathjax>200,000,000
| <nomathjax>$</nomathjax>199,999,998
| $\dfrac{1}{175,223,510}$
|- align="center"
| OOOOO
| <nomathjax>$</nomathjax>1,000,000
| <nomathjax>$</nomathjax>999,998
| $\dfrac{34}{175,223,510}$
|- align="center"
| OOOO<span style="color:red;"> P </span>
| <nomathjax>$</nomathjax>10,000
| <nomathjax>$</nomathjax>9,998
| $\dfrac{270}{175\text{,}223\text{,}510}$
|- align="center"
| OOOO
| <nomathjax>$</nomathjax>100
| <nomathjax>$</nomathjax>98
| $\dfrac{9\text{,}180}{175\text{,}223\text{,}510}$
|- align="center"
| OOO<span style="color:red;">$P$</span>
| <nomathjax>$</nomathjax>100
| <nomathjax>$</nomathjax>98
| $\dfrac{14\text{,}310}{175\text{,}223\text{,}510}$
|- align="center"
| OOO
| <nomathjax>$</nomathjax>7
| <nomathjax>$</nomathjax>5
| $\dfrac{486\text{,}540}{175\text{,}223\text{,}510}$
|- align="center"
| OO<span style="color:red;">$P$</span>
| <nomathjax>$</nomathjax>7
| <nomathjax>$</nomathjax>5
| $\dfrac{248\text{,}040}{175\text{,}223\text{,}510}$
|- align="center"
| O<span style="color:red;">$P$</span>
| <nomathjax>$</nomathjax>4
| <nomathjax>$</nomathjax>2
| $\dfrac{1\text{,}581\text{,}255}{175\text{,}223\text{,}510}$
|- align="center"
| <span style="color:red;">$P$</span>
| <nomathjax>$</nomathjax>4
| <nomathjax>$</nomathjax>2
| $\dfrac{3\text{,}162\text{,}510}{175\text{,}223\text{,}510}$
|- align="center"
| Losing ticket
| <nomathjax>$</nomathjax>0
| -<nomathjax>$</nomathjax>2
| $\dfrac{169\text{,}721\text{,}370}{175\text{,}223\text{,}510}$
|}
</center>
...
| OOOOO<span style="color:red;">P</span>
| $$\$199\text{,}999\text{,}998$$
| $$\frac{1}{175\text{,}223\text{,}510}$$
| $\displaystyle{\$199\text{,}999\text{,}998\times\frac{1}{175\text{,}223\text{,}510}≈0.00000000571}$
|-
| OOOOO
| $$\$999\text{,}998$$
| $$\frac{34}{175\text{,}223\text{,}510}$$
| $\displaystyle{\$999\text{,}998\times\frac{34}{175\text{,}223\text{,}510}≈0.000000194}$
|-
| OOOO<span style="color:red;">P</span>
| $$\$9\text{,}998$$
| $$\frac{270}{175\text{,}223\text{,}510}$$
| $\displaystyle{\$9\text{,}998\times\frac{270}{175\text{,}223\text{,}510}≈0.000001541}$
|-
| OOOO
| $$\$98$$
| $$\frac{9\text{,}1890}{175223\text{,}510}$$
| $\displaystyle{\$98\times\frac{9\text{,}180}{175\text{,}223\text{,}510}≈0.000052390}$
|-
| OOO<span style="color:red;">P</span>
| $$\$98$$
| $$\frac{14\text{,}310}{175\text{,}223\text{,}510}$$
| $\displaystyle{\$98\times\frac{14\text{,}310}{175\text{,}223\text{,}510}≈0.000081660}$
|-
| OOO
| $$\$5$$
| $$\frac{486\text{,}540}{175\text{,}223\text{,}510}$$
| $\displaystyle{\$5\times\frac{486\text{,}540}{175\text{,}223\text{,}510}≈0.002776682}$
|-
| OO<span style="color:red;">P</span>
| $$\$5$$
| $$\frac{248\text{,}040}{175\text{,}223\text{,}510}$$
| $\displaystyle{\$5\times\frac{248\text{,}040}{175\text{,}223\text{,}510}≈0.001415563}$
|-
| O<span style="color:red;">P</span>
| $$\$2$$
| $$\frac{1\text{,}581\text{,}255}{175\text{,}223\text{,}510}$$
| $\displaystyle{\$2\times\frac{1\text{,}581\text{,}255}{175\text{,}223\text{,}510}≈0.009024217}$
|-
| <span style="color:red;">P</span>
| $$\$2$$
| $$\frac{3\text{,}162\text{,}510}{175\text{,}223\text{,}510}$$
| $\displaystyle{\$2\times\frac{3\text{,}162\text{,}510}{175\text{,}223\text{,}510}≈0.018048434}$
|-
| Losing ticket
| $$\$-2$$
| $$\frac{169\text{,}721\text{,}370}{175\text{,}223\text{,}510}$$
| $\displaystyle{\$-2\times\frac{169\text{,}721\text{,}370}{175\text{,}223\text{,}510}≈0.968599305}$
|-
|
| Total
| Sum: 1
...
The fact that the mean is <nomathjax>$</nomathjax>$-$0.4981 says that the average profit of each Powerball lottery ticket is actually a loss of 50 cents. In other words, players lose 50 cents on average, every time they play.
...
| Sum: 1
| Sum: $\mu=\$-0.4981$
| Sum: $\sigma^2$=228474061.2
|}
</center>


The standard deviation is $$ \sigma = \sqrt{\sigma^2}=\sqrt{228\text{,}474\text{,}061.2}=\$15\text{,}115.36$$ The standard deviation measures how spread out the profits are. On average, we can expect profits to be about <nomathjax>$</nomathjax>15,115.36 away from the mean profit of <nomathjax>$</nomathjax>$-$0.50. The standard deviation is so large in this example because of all the outliers: Every positive profit (<nomathjax>$</nomathjax>2, <nomathjax>$</nomathjax>5, <nomathjax>$</nomathjax>98, and so on) occurs so rarely as to qualify to be an outlier. In addition, the profit <nomathjax>$</nomathjax>199,999,998 is a very large outlier. Almost everyone who plays has a profit of <nomathjax>$</nomathjax>$-$2, however, so the vast majority of the data aren't spread out at all. Recall from Lesson 3 that the standard deviation is not resistant to outliers. Powerball profits are a rather dramatic example of this lack of resistance.

The population mean is also called the '''expected value'''.  How do we interpret the population mean or expected value of $\mu=\$-0.4981$?  If you played Powerball, buying one ticket every week, forever, then the mean of your winnings would be very close to <nomathjax>$</nomathjax>$-$0.50. This takes into account that on rare occasions&mdash;about once in every 175 million weeks&mdash;you would win the jackpot. Most of the time (about 97% of the time,) you would win nothing!  In the long run, if you look at your mean profit, your financial situation would be the same whether you were to throw 50 cents away every week or whether you were to play Powerball each week. Of course, this assumes that you live forever and always play. In practice, however, most people do not live forever playing Powerball. Most likely, you will lose much more than you win.
...
<div style="clear:both"></div>
<div class="mw-collapsible mw-collapsed" data-collapsetext="Hide this Optional Section" data-expandtext="Click Here to Explore this Optional Section">

The following stories describe how winning a huge Powerball jackpot changed the life of Jack Whittaker, for the worse.

:[http://abcnews.go.com/2020/powerball-winner-cursed/story?id=3012631#.TxRrefkprTp (Print story)]

:[http://abcnews.go.com/2020/video/unlucky-lotto-winner-3023380 (Lottery Curse Video)]

:[http://abcnews.go.com/2020/video/lotto-winner-wishes-hed-torn-ticket-3016773 (Lottery Curse Video–Part II)]
...
{| 
|- align="center"
| '''Previous Reading''': <br> Lesson 03:  <br> [[Lesson 3: Describing Quantitative Data: Shape, Center & Spread|Describing Quantitative Data: Shape, Center & Spread]]
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
| '''This Reading''': <br> Lesson 04:  <br> Probability; Discrete Random Variables
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
| '''Next Reading''': <br> Lesson 05:  <br> [[Lesson 5: Normal Distributions|Normal Distributions]]
|}
