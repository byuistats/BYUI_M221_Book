...
* Determine the mean and median of left-skewed, right-skewed, or bell-shaped distributions visually using a histogram.
* Identify regions of high density and low density for a given quantitative variable using a histogram.  
* Appropriately use the Excel functions AVERAGE, MEDIAN, and MODE when working with quantitative data in Excel.
* Interpret the mean, median, and mode for quantitative data.
* Perform proper arithmetic operations in Excel (+,-,*,/,SQRT) using the order of operations.
* Properly save work contained in an Excel file.
...
2. Next, in the cell where you would like to store the numerical summary type an "=", followed by the name of the function and then an open parenthesis, "(".  
3. Then,  highlight the data to which you want to apply the function. The cell reference range will automatically be added to your formula. Then type a closed parenthesis, ")" and hit enter.
