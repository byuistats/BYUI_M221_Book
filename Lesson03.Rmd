...
To make a histogram in Excel, you can use the Excel file [Math 221 Statistics Toolbox](./Data/Math221StatisticsToolbox.xlsx). First, enter the 10 data values in the first column (on the left side) of the tool, the histogram will be generated automatically. You can practice creating a histogram in Excel using the data provided on the 10 patients.
...
&nbsp;&nbsp;If you do not know how to use Excel to find the mean and median, the spreadsheet [Math 221 Statistics Toolbox](./Data/Math221StatisticsToolbox.xlsx) has been created to make these calculations for you.

- Download and open the Excel spreadsheet. Make sure you are on the worksheet labeled "Descriptive Stats". (This is the red tab at the bottom the far left).
...
- Copy and paste the desired data into Column A of the spreadsheet [Math 221 Statistics Toolbox](./Data/Math221StatisticsToolbox.xlsx).
