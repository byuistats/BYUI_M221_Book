...
To make a histogram in Excel, you can use the Excel file [Quantitative Descriptive Statistics](./Data/QuantitativeDescriptiveStatistics.xlsx). First, enter the 10 data values in the first column (on the left side) of the tool, the histogram will be generated automatically. You can practice creating a histogram in Excel using the data provided on the 10 patients.
...
&nbsp;&nbsp;If you do not know how to use Excel to find the mean and median, the spreadsheet {{Spreadsheet|QDS}} has been created to make these calculations for you.
...
<center><img src="./Images/DiveSeals-Mass-Stats.png"></center>
<br>
</div>
<br>
<!-- To access this content, scroll to the bottom of the editing page and click on the link "Software:(Excel or SPSS)-(PageName)" -->
...
<center>Mass (kg) of the Diving Elephant Seals in Excel:
...
<div class="stats B C">
<center>**Length of Time Data were Collected on each Seal**</center>
<img src="./Images/SPSS_Histogram_Diving_Seals_length_of_deployment.jpg">
</div>
</div>
<br>
...
<a href="javascript:showhide('Q10')"><span style="font-size:8pt;">Refresh My Memory</span></a>
<div id="Q10" style="display:none;">
<!-- To access this content, scroll to the bottom of the editing page and click on the link "Software:(Excel or SPSS)-(PageName)" -->
To make a histogram in Excel, you can use the Excel file 
[Quantitative Descriptive Statistics](./Data/QuantitativeDescriptiveStatistics.xlsx). 
Copy and paste the desired data values into the first column (on the left side) of the tool. The histogram will be generated automatically.

<center><img src="./Images/Lesson_2_Activity_2-2.JPG"></center>
</div>
&nbsp;
</div>
<br>
...
- Copy and paste the desired data into Column A of the spreadsheet [Quantitative Descriptive Statistics](./Data/QuantitativeDescriptiveStatistics.xlsx).
