...
- Once you have already entered in the explanatory and response variables into the correct columns in the [Math 221 Statistics Toolbox](./Data/Math221StatisticsToolbox.xlsx) spreadsheet, you are given a scatter plot of residuals starting in cell S21, just below the Normal Q-Q plot.  
...
The Q-Q plot of the residuals for the estuarine crocodile data show a straight line.  We do not have evidence of nonnormality in the residuals.  We conclude that the residuals are normally distributed. Looking at a histogram of the residuals is another tool to help you assess whether the residuals are normally distributed.
