...
- Once you have already entered in the explanatory and response variables into the correct columns in the [Math 221 Statistics Toolbox](./Data/Math221StatisticsToolbox.xltx) spreadsheet, you are given a scatter plot of residuals starting in cell S21, just below the Normal Q-Q plot.  
