...
<iframe width="90%" align="right" src="http://www.youtube.com/embed/videoseries?list=PLaZryQtbPQC9acEfJHNYCs9N93R2CJ8zB" frameborder="1" allow="autoplay; encrypted-media" allowfullscreen></iframe>
</div>
...
- In the Excel sheet [CategoricalDataAnalysis.xlsx](./Data/CategoricalDataAnalysis_Hat.xlsx), go to the third tab on the file.  This tab, entitled "Chi-Square", will allow you to perform tests for independence.  Excel allows us to enter data in the same way as the table above, so enter the data in the following manner on the excel sheet:
...
<div class="SoftwareHeading">Excel Instructions</div>
<div class="Summary">
- After entering the data correctly into [CategoricalDataAnalysis.xlsx](./Data/CategoricalDataAnalysis_Hat.xlsx), the Chi-Square statistic, degrees of freedom, and $P$-value are all displayed in the top right of the excel sheet.  The data for this example will look like:
...
For the chiropractic data set, the analysis would be conducted as follows <!--[To do: Flesh this out a bit]:-->
