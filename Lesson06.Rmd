...
- **Step 5**: Repeatedly pushing the [Animated] button produces more samples of size 25, calculates the mean of each sample, and then places the mean in the Distribution of Means graph.  Play with this a few times to make sure you understand the process.
