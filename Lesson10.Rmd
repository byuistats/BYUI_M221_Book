...
When we consider the margin of error, we estimate that the true proportion of people who favor the Republican candidate is 49% &plusmn; 3%, or in other words between 46% and 52%.  It is not obvious wether the Republican candidate is favored by more or less than 50% of the voters. In this case, the political race is too close to know who might win.
