...
:* Obtain access to a spreadsheet program {{Course_Filter|course=A B C|content=(Microsoft Excel)}}
...
If you have never taken a hybrid class before, you are in for a new and exciting learning experience. This course uses some of the most advanced educational tools. These technologies will help you learn in an effective and efficient way, often allowing you to learn more than you would in a traditional Statistics class---and in less time. Although some of the learning activities will require you to work on your own, you will also be engaged in activities with other students and your instructor. Through your group interactions, you will have many opportunities to teach one another by sharing ideas and solving problems together.
...
As you thoughtfully prepare, teach one another, ponder/prove what you have learned, and as you humbly seek the guidance of the Holy Spirit, the Lord will bless you with a greater knowledge of His mercy and love. You will have the opportunity to increase your testimony of the Gospel of Jesus Christ. You will also learn about Statistics, more deeply, permanently, and usefully than you would have, otherwise.<!--That last sentence needs improving-->
...
# Determine the correct procedures to use in a given situation.
...
You will experience much deeper learning if you follow the Five Principles of the [http://www.byui.edu/LearningModel BYU-Idaho Learning Model]:
...
You will learn more in less time if you follow the Three Process Steps of the [http://www.byui.edu/LearningModel BYU-Idaho Learning Model]:
...
Here is a link to the {{Schedule_Link}} we will use this semester. <br>
The schedule is also available under Course Resources on the [[Main Page]].

The lesson pattern discussed above is repeated twice a week.  

{{Type_Filter|type=Online|content={{:Online:Weekly_Schedule}} }}

{{Type_Filter|type=Classroom|content={{:Classroom:Weekly_Schedule}} }}
...
{|
|- align="center"
| '''This Reading''': <br> Lesson 01:  <br> Course Introduction
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
| '''Next Reading''': <br> Lesson 02:  <br> [[Lesson 2: The Statistical Process & Design of Studies|The Statistical Process & Design of Studies]]
|}
</center>
